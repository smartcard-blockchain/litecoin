...
"""Verify that starting smartcardcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start smartcardcoin with -h for help text")
        ...
        self.log.info("Start smartcardcoin with -version for version information")
