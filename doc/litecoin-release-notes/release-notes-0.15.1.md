Smartcardcoin Core version *0.15.1* is now available from:

  <https://download.smartcardcoin.org/smartcardcoin-0.15.1/>
...
A number of changes to the way Smartcardcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 smartcards per kB (0.00001 SCC). This is to prepare for dropping the minimum transaction fee to 0.1 smartcards per kB (0.0001 SCC) in the next release.
