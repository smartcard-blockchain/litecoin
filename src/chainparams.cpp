...
{
    const char* pszTimestamp = "BBC News 01/Jan/2019 New Year celebrations UK welcomes in 2019";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1546344162, 2085695767, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x433108320d7fb242453e737846541548d569cdf5cf95e23465f36fa603aff8fa"));
        assert(genesis.hashMerkleRoot == uint256S("0x78976669ace8c59b78ccc8d0c81e4e9bae5b9f580474d1544f8c974fd0a97084"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("dnsseed.smartcardcoin.com");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.smartcardcointools.com");
        //vSeeds.emplace_back("dnsseed.smartcardcoinpool.org");
		...
		{  0, uint256S("0x433108320d7fb242453e737846541548d569cdf5cf95e23465f36fa603aff8fa")},
                ...
                { 16128, uint256S("0x0d4c7b32a981a0908832dfe4f703197f5ca33bfd8418083b767412ff8b0576c6")},
                { 23420, uint256S("0x13baad7f70a5a5d2d6e7112f0129ab5378eeb77ef537cf382ec6a3acfe2e187e")},
/*
...
*/
        ...
        chainTxData = ChainTxData{
            ...
            1546344162, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1684915, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xff22745152d3de6bfa04435bdef37c23077aee2049b54d623b98822e8d4afa71"));
        assert(genesis.hashMerkleRoot == uint256S("0x78976669ace8c59b78ccc8d0c81e4e9bae5b9f580474d1544f8c974fd0a97084"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.smartcardcointools.com");
        //vSeeds.emplace_back("seed-b.smartcardcoin.loshan.co.uk");
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("ff22745152d3de6bfa04435bdef37c23077aee2049b54d623b98822e8d4afa71")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x59a40e626a7883b222cdb48b0a4238df12deacdeb8a14e8186b0ac9820622393"));
        assert(genesis.hashMerkleRoot == uint256S("0x78976669ace8c59b78ccc8d0c81e4e9bae5b9f580474d1544f8c974fd0a97084"));
        ...
        checkpointData = {
            {
                {0, uint256S("59a40e626a7883b222cdb48b0a4238df12deacdeb8a14e8186b0ac9820622393")},
            }
        };
