...
#if defined(NDEBUG)
# error "Smartcardcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Smartcardcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("smartcardcoin-scriptch");
