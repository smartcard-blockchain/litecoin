...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s smartcardcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  smartcardcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smartcardcoin transaction") + "\n" +
              "  smartcardcoin-tx [options] -create [commands]   " + _("Create hex-encoded smartcardcoin transaction") + "\n" +
              "\n";
